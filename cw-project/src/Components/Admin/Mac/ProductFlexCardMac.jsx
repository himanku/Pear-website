...
import { addTask } from '../../../Redux/AdminMac/action';
    ...
    <div>
        ...
        <Flex alignItems="center" justifyContent="space-between" gap="10px">
            <Flex w={{base:"200px", sm:"300px"}} justifyContent="space-around" borderRadius="10px" p="10px" boxShadow= "rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px">
                ...
                <Box>
                    <Text fontSize={{base:"13px", sm:"20px"}} fontWeight="bold" color="gray.600">TOTAL MACs</Text>
                    <Text fontSize={{base:"13px", sm:"20px"}}>{tasks.length}</Text>
                </Box>
            </Flex>
            <Button variant="outline" colorScheme="cyan" size="sm" onClick={onOpen}>ADD MAC</Button>
            <Modal
...
export default ProductFlexCardMac